...
namespace Programming.View.Blocks
{
    public partial class RectanglesControl : UserControl
    {
        ...
        public RectanglesControl()
        {
            ...
            GenerateRandomRectangles(5);
        }

        /// <summary>
        /// Генерирует заданное количество случайных прямоугольников и добавляет их в список.
        /// </summary>
        /// <param name="count">Количество прямоугольников для генерации.</param>
        private void GenerateRandomRectangles(int count)
        {
        ...
        private void FindButton_Click(object sender, EventArgs e)
        {
            ...
            if (index != -1)
            {
                ...
                RectanglesListBox_SelectedIndexChanged(null, null);
            }
        }
