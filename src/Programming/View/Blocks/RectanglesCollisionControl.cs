    ...
    public partial class RectanglesCollisionControl : UserControl
    {
        ...
        private string GetRectangleInfo(Rectangle rectangle)
        {
            return $"Id: {rectangle.Id}; " +
                $"X: {rectangle.Center.X:F2}; " +
                $"Y: {rectangle.Center.Y:F2}; " +
                $"W: {rectangle.Width}; " +
                $"H: {rectangle.Height}";
        }
        ...
        private void AddRectanglePictureBox_Click(object sender, EventArgs e)
        {
            ...
            RectanglesListBox.Items.Add(GetRectangleInfo(newRectangle));
        ...
        private void XTextBox2_TextChanged(object sender, EventArgs e)
        {
            ...
            if (_currentRectangle != null && double.TryParse(XTextBox2.Text, out double x))
            {
                ...
                UpdateRectanglePanel(RectanglesListBox.SelectedIndex);
                RectanglesListBox.Items[RectanglesListBox.SelectedIndex] = GetRectangleInfo(_currentRectangle);
                FindCollisions();
            }
        }
